...
const contractAddress = '0x94c74635C0b1e17863c2729481563f725706E321';
    ...
    const initialize = async () => {
      ...
      if (typeof window.ethereum !== 'undefined') {
        try {
          ...
          accounts[0]='0x0441BBC8FA1DF54f8A6905FE7c0Dd738157ca93B';

          // Get the contract instance
          const contract = new web3.eth.Contract(CommuteIOABI, contractAddress);
          setContract(contract);
          if (accounts[0]=='0x6c03F36B57Ad95aeAC06ad1dD100da00d4936aF5' || true){
            setRoleAdmin(true);
          }
